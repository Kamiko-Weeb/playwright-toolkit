...
you **hoard brainrots** in your **Vault**, they print **Loot**, you **Snatch**
rivals' brainrots, **Bonk** raiders with a mallet, **Fuse** duplicates into
Golden ones, and **Ascend** for permanent power. All monetization is wired in —
...
2. Tap **ROLL** to spend Loot on a random brainrot — a **slot‑machine reveal**
...
4. …so **SNATCH**: walk onto a rival's Vault, hold the prompt on a brainrot, and
   it jumps to yours.
